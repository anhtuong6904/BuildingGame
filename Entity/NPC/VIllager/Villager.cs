...
//             var path = world.FindPath(npcBody.Position, escapePoint);
...
//             GameWorld world = GameManager.Instance?.World;
//             // Move to home with pathfinding
//             if (!npcBody.IsMoving())
//             {
//                 var path = world.FindPath(npcBody.Position, HomePosition);
...
//                     if (!npcBody.IsMoving())
//                     {
//                         var path = world.FindPath(npcBody.Position, CurrentTask.WorkLocation.Value);
...
//                 {
//                     GameWorld world = GameManager.Instance?.World;
//                     var path = world.FindPath(npcBody.Position, wanderTarget.Value);
